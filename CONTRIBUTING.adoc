...
osgi-email is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/osgi-email/issues/new/choose[issue form].
